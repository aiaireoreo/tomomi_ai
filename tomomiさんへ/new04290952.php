        ...
        <div class="panel-body">
          ...
          <?php if(!empty($error['photo_path'])): ?>
            <?php if($error['photo_path'] == 'blank'): ?>
                <p class="required">写真を選択してください。</p>
            <?php endif; ?>
          ...
          <div class="control-group">
            <h5>タイトルを入力してください。<span class="required">*30文字以内</span></h5>
            <div class="controls">   
              ...
              <?php if(!empty($error['title'])): ?>
                <?php if($error['title'] == 'blank'): ?>
                  <p class="required">タイトルを入力してください。</p>
                <?php endif; ?>
                <?php if($error['title'] == 'length'): ?>
                  <p class="required">タイトルは30文字以内で入力してください。</p>
                <?php endif; ?>
              <?php endif; ?>
            </div>
          </div>
          <br>
          <div class="control-group">
            <h5>写真に関するエピソードを書いてみんなにアピールしよう！<span class="required">*500文字以内</span>
            </h5>
          <div class="controls">
            <?php if(!empty($_POST['comment'])): ?>
              <textarea class="photo_message" name="comment"><?php echo h($_POST['comment']); ?></textarea>
            <?php else: ?>
